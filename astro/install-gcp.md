...
- The `https://cloud.astronomer.io/`, `https://astro-<your-org>.datakin.com/`, `https://api.astronomer.io/`, `https://images.astronomer.cloud/`, `https://auth.astronomer.io/`, `https://updates.astronomer.io/`, `https://install.astronomer.io/`, and `https://<your-org>.astronomer.run/` domains added to your organization's allowlist.
