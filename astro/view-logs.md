...
- API events: Data is generated by user actions in the Cloud UI, Astro CLI, or from internal processing actions in the Astro control plane.
- Airflow UI access: Data is generated when users access the Airflow UI.
- Astronomer container registry access: Data is generated when users access the Astronomer container registry with the Astro CLI.
