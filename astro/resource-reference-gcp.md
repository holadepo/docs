...
| [CloudSQL For PostgresSQL](https://cloud.google.com/sql/docs/postgres) | The CloudSQL Instance is the primary database of the Astro Data Plane; it hosts the metadata database for each Airflow Deployment hosted on the GKE cluster | 1 Regional Instance with 4 vCPUs, 16GB Memory |
