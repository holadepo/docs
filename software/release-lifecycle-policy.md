...
> **Note:** Release channels apply to Astronomer Software and Astronomer Certified versions. Astronomer does not currently support a long-term release channel for the Astro CLI.
